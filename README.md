# Data Portfolio: Excel to Power BI by Ankan Mazumdar
...
To create a dashboard that provides insights into the top YouTubers in 2024 that includes their 
- subscriber count
- total views
- total videos, and
- engagement metrics
...
As the Head of Marketing, I want to use a dashboard that analyses YouTube channel data. 
...
We need data on the top YouTubers in 2024 that includes their 
- channel names
- total subscribers
- total views
...
# 3. Select the required columns from the top_youtubers_2024 SQL table 
*/
...
![GIF of Power BI Dashboard](assets/images/top_youtubers_2024.gif)

This shows the Top Youtubers in 2024 so far. 
...
Total Subscribers (M) = 
VAR million = 1000000
VAR sumOfSubscribers = SUM(view_youtubers_2024[total_subscribers])
...
VAR sumOfTotalViews = SUM(view_youtubers_2024[total_views])
...
```sql
Total Videos = 
VAR totalVideos = SUM(view_youtubers_2024[total_videos])
...
VAR sumOfTotalViews = SUM(view_youtubers_2024[total_views])
VAR sumOfTotalVideos = SUM(view_youtubers_2024[total_videos])
...
VAR sumOfTotalSubscribers = SUM(view_youtubers_2024[total_subscribers])
VAR sumOfTotalVideos = SUM(view_youtubers_2024[total_videos])
...
WITH ChannelData AS (
    ...
    FROM 
        youtube_db.dbo.view_youtubers_2024
)
...
1. NoCopyrightSOunds, Dan Rhodes and DanTDM are the channnels with the most subscribers
...
1. Dan Rhodes is the best YouTube channel to collaborate with if we want to maximize visbility because this channel has the most YouTube subscribers
